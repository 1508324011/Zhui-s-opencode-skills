---
name: "skill-creator"
description: "Create or improve OpenCode skills, bundle helper resources, package `.skill` archives, and design evaluation or review workflows for skills. Use when the user wants to author a new `SKILL.md`, refine an existing skill's instructions or triggering, add scripts/references/assets to a skill, or prepare a skill for distribution. In this OpenCode adaptation, prefer conversational and subagent-based review loops; bundled trigger-optimization scripts remain upstream Claude Code reference utilities."
license: "Proprietary. See LICENSE.txt for complete terms."
metadata:
    skill-author: Anthropic (adapted for local OpenCode installation)
    upstream-source: https://github.com/anthropics/skills/tree/main/skills/skill-creator
    upstream-skill-name: skill-creator
...
- Create a few test prompts and run an OpenCode session or subagent with access to the skill on them
...
The skill creator is liable to be used by people across a wide range of familiarity with coding jargon. Across modern agent tools, it's increasingly common for people with very different technical backgrounds to open a terminal and start building automations. On the other hand, the bulk of users are probably fairly computer-literate.
...
Package the skill into a distributable `.skill` archive when the user wants an exportable artifact:
...
## Upstream reference: Claude.ai-specific instructions
...
## Upstream reference: Cowork-specific instructions
...
- Run OpenCode test prompts with the skill available
